...
export function AboutNest() {
  return (
    <section
      id="about-nest"
      className="section-soft relative py-20 sm:py-28"
        ...
        <ParallaxSection className="max-w-5xl mx-auto">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="section-elevated mt-8 rounded-2xl p-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="relative col-span-2 aspect-[16/9] overflow-hidden rounded-2xl shadow-xl ring-1 ring-white/60">
                <Image
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-xl ring-1 ring-white/60">
                <Image
